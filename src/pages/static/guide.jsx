...
export default class Guid extends Component {
	componentWillMount(){
		document.title="下载引导";
		window.location.href = "jsbridge://set_title?title=下载引导";
	}
  componentDidMount() {
		  ...
		  var jumpUrl = 'trc://open_link_in_new_window?url='+base64encode(utf16to8(redirect)),
  ...
  render() {
    return (
		...
		<img width="100%"  src="https://www.trc.com/themes/wapmall/images/bg.jpg" />
			<img className="trc-log" width="100%"  src="https://www.trc.com/themes/wapmall/images/pic.png" />
				<div className="appGuide_main">
					<div className="appGuide_content">
						<div className="app_download_btn"><a id="downloadAppLink"  href="javascript:;"><img src="https://www.trc.com/themes/wapmall/images/btn.png" width="100%" /></a></div>
						<p className="copyright">©TRC.COM　浙江小泰科技有限公司　版权所有</p>
					</div>
				</div>
				<div id="weixinBrowserMask" className="weixin-download-mask">
					<img width="100%" height="100%" src="https://www.trc.com/themes/wapmall/images/zhezhao.png" />
				</div>
