                ...
                <Fix>
                    <div className="tab-ti-wrap">
                        <div className="tab-ti">
                            <ul>
                                <li className={this.checkTag(0)} onClick ={()=>this.changeTag(0)} style={{width:'33%'}}><span>图文详情</span>
                                </li>
                                <li className={this.checkTag(1)} onClick={()=>this.changeTag(1)} style={{width:'33%'}}><span>商品参数</span>
                                </li>
                                <li className={this.checkTag(2)} onClick={()=>this.changeTag(2)} style={{width:'33%'}}><span>理财乐享</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div className="pro_li_con">
                                        乐享是泰然金融为满足用户不断提升的消费需求而推出的消费金融产品。用户投资一定份额的乐享产品，即可免费获得对应的商品，还可以赚取理财收益，尽享“先消费，再拿收益”的优质服务。
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div className="pro_li_con">
                                        ...
                                        <a href={"taihe://to_invest_detail?type=5&term="+this.props.nowInvest.period+"&trcProductUrl="+base64encode(utf16to8(location.href))}  className="item_intro action-update-link_h5">点击查看该商品对应的项目介绍</a>
                                    </div>
                                </li>
...
export class ZeroMoney extends Component {
    render() {
        ...
        return (<div><div className="store_money">
            <ul className="c-cb">
                <li>
                ...
                <li>
                    ...
                    <div className="s_li_con"><span>￥</span><span className="action-update-expect_profit">{profit.toFixed(2)}</span></div>
                </li>
            </ul>
        </div>
            <div className="gap bgf4"></div>
    ...
    clickBuy() {
        $.ajax(Action("toCart", {
                data: {
                    ...
                    "params[profit]": this.props.profit,
                    "obj_type": "zero_buy",
                    "mode": "fast_buy"
                },
                success:(result) =>{
                    if( !result.status ){
                        switch (result.code) {
                            case 10001:
                                setTimeout(() => { location.href = "taihe://to_lianlian_account_authentication_select_bankCard"});
                                break;
                            case 10002:
        ...
        return (
            <div className="buy-amount" id="buy-amount">
                ...
                <div className="action-btn-group c-fr">
                    {this.getStore() ?
                        <LinkChange className="ui-btn buy_fast buy-now  ui-btn-warning action-fastbuy_btn" onClick={() =>this.clickBuy()}>免费拿</LinkChange>
...
class PopupWrap extends Component {
    render () {
        ...
        return ( popup ? <PopupTip active = {true} msg={createMSG(popup.messageType, popup.messageArg)} onClose={onClose} /> : null )
    }
}

let popupStateToProps = (state) => {
    return state.zeroBuy
}
...
let PopupWrapCtrl = connect(popupStateToProps, popupActionToProps)(PopupWrap);
