...
const ctrlAPI ={
	init:{url:"/api/trade-init.html",type:"get"},
			...
			<div className="order-form">
				...
				{agree?
					( +data.invest > rest.balance?
							<a className="form-btn c-bgdred" href={`taihe://to_recharge?amount=${+data.invest-rest.balance}`} >充值{(+data.invest-rest.balance).toFixed(2)}元购买</a>:
